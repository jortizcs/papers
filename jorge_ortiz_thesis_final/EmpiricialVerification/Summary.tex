...
of the trace to classify the category of the trace, as labled by the user.  However, for large traces with many
overlapping categories we observed that the traces are very similar and cannot be distinguised.  In order to uncover we may need out-of-band
