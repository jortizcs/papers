...
% it is an implicit factor in correlated-usage patterns; changes in such a pattern 
...
% unaware of what is optimal, only what is common.  Uncommon behavior is flagged in hopes
