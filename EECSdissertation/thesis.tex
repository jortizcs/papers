...
%% [UNCOMMENT THIS IF USING pdflatex]
\pdfinfo{
...
\field{Electrical Engineeing and Computer Sciences} 
...
% CHAPTERS
\chapter{Introduction}    % Put the title of the first chapter on this line
	\input{introduction}  %% Adds the contents of the file introduction.tex
	%%% The file should have no preamble -- the chapter body.
	
\chapter{Title of another chapter}  % Put the title of next chapter on this line
	\input{chapter2}		%% Adds the contents of chapter2.tex here
