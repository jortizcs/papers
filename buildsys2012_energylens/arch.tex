...
% % 2) tell us which meters are attached to which items, and 3) scan individual items to view their load curve over a 
% % 24-hour period.
...
are created).  
% The following general path-naming patterns are used to express different portions of the ERG.
...
% \item {\bf Attached-to}: When a meter/qr code/item is attached to another meter/qr code/item but \emph{not} taking any 
