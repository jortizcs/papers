...
% As the deployment is on-going, we evaluate the log-replay and 
% transaction manager via synthetic traces.  % -- capturing conflicts that we expect to occur
...
% 		dynamics of a changing set data sources; fundamentally linked with the virtual view of the physical world.
% \end{itemize}
