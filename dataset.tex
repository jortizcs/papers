...
\begin{figure}
\centering
 \subfigure[EHP trace]{\label{fig:raw_ehp}\includegraphics[width=.45\textwidth]{img/25.png}}
 \subfigure[Light trace]{\label{fig:raw_light}\includegraphics[width=.45\textwidth]{img/26.png}}
 \subfigure[GHP trace]{\label{fig:raw_ghp}\includegraphics[width=.45\textwidth]{img/41.png}}
