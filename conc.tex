...
of simultaneous heating and cooling~\cite{simheatcool}; a non-trivial exercise in modern buildings.
Simultaneous heating and cooling is when heating
and cooling system either compete with one another or compete with the incoming air from outside and is
a cause for major energy waste in building.  The longer it goes undetected,
...
was on, but the lights were off.  The two are typically correlated, however, in this case where they were not.
