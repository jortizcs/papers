...
\title{StreamFS: Streaming file data abstraction for sensor deployment data collection and analysis}
...
\begin{enumerate}
\item Stream file abstraction.
\end{enumerate}

\section{Evaluation}
\begin{enumerate}
\item Compare with simple logging.
\item compare with scribe.
\item comapre with chukwa.
\end{enumerate}
